...
class Rmusic extends React.PureComponent {
  constructor(props) {
    super(props)
  }
  state = {
    ...
    const data = {
      ...
      audioLists: [
        ...this.state.params.audioLists,
        {
          name: "ChemTrails",
          singer: 'Chaotic Order',
          cover: 'https://github.com/salemaziel/chaoticordermusic2/blob/master/public/static/Feed%20The%20People/Chemtrails.jpg',
          musicSrc: `https://github.com/salemaziel/chaoticordermusic2/blob/master/public/static/Feed%20The%20People/1-Chemtrails.mp3`
        }
      ]
    }
    this.setState({
